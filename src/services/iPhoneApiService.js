...
export const iPhoneApi = (data) => {
    return API.get(BASE_re_path + `/api/iphoneapi?capacity=${data.capacity}&carrier=${data.carrier}&iphone_model=${data.iphone_model}&condition=${data.condition}`)
}

export const iPadApi = (capacity, carrier, iphone_model, condition, ipad_screensize, ipad_generation) => {
    return API.get(BASE_re_path + `/api/ipadapi?ipad_capacity=${capacity}&ipad_carrier=${carrier}&ipad_model=${iphone_model}&ipad_condition=${condition}&ipad_screensize=${ipad_screensize}&ipad_generation=${ipad_generation}`)
}

export const mackBookApi = (data) => {
    return API.get(BASE_re_path + `/api/macbookapi/?macbook_model=${data.macbook_model}&screen_size=${data.screen_size}&year=${data.year}&processer=${data.processer}&cosmetic_condition=${data.cosmetic_condition}&ram_capacity=${data.ram_capacity}&storage_capacity=${data.storage_capacity}&battery_health=${data.battery_health}&macbook_functional=${data.macbook_functional}&macbook_powercord=${data.macbook_powercord}&graphics_card=${data.graphics_card}&touch=${data.touch}`)
}

export const androidApi = (data) => {
    return API.get(BASE_re_path + `/api/samsungapi/?samsung_model=${data.samsung_model}&samsung_carrier=${data.samsung_carrier}&samsung_condition=${data.samsung_condition}&samsung_functional=${data.samsung_functional}&samsung_powercord=${data.samsung_powercord}&samsung_box=${data.samsung_box}&samsung_headset=${data.samsung_headset}&samsung_isunlock=${data.samsung_isunlock}&samsung_screenburn=${data.samsung_screenburn}`)
}

export const googleApi = (data) => {
    return API.get(BASE_re_path + `/api/googleapi/?google_model=${data.google_model}&google_capacity=${data.google_capacity}&google_carrier=${data.google_carrier}&google_condition=${data.google_condition}&google_functional=${data.google_functional}&google_powercord=${data.google_powercord}&google_box=${data.google_box}&google_headset=${data.google_headset}`)
}

export const iPodApi = (airpods_model, charging_case, airpods_condition) => {
    return API.get(BASE_re_path + `/api/airpodsapi/?airpods_model=${airpods_model}&charging_case=${charging_case}&airpods_condition=${airpods_condition}`)
}
